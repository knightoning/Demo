...
public class LambdaTest {
    ...
    public static void main(String[] args) {
        ...
        Person pers = javaProgrammers
                ...
                .get();
        System.out.printf(" 工资最低的 Name: %s %s; Salary: $%,d.", pers.getFirstName(), pers.getLastName(), pers.getSalary());
        ...
        Person person = javaProgrammers
                ...
                .get();
        System.out.printf(" 工资最低的 Name: %s %s; Salary: $%,d.", person.getFirstName(), person.getLastName(), person.getSalary());
        ...
        System.out.println(" PHP programmers 的 first name 拼接成字符串:"+phpDevelopers);
