...
/**
 * @author hujie
 * @version Id: ZkWatchAPI.java, v 0.1 2018/1/10 10:52 hujie Exp $$
 */
public class ZkWatchAPI implements Watcher{
    ...
    public void connectionZookeeper(String connectString, int sessionTimeout){
        ...
        try {
            ...
            System.out.println("连接创建失败，发生 InterruptedException , e " + e);
        } catch ( IOException e ) {
            System.out.println( "连接创建失败，发生 IOException , e " + e );
        }
    }
    ...
    public void releaseConnection() {
        if ( null != zk ) {
            try {
                ...
                System.out.println("release connection error ," + e);
            }
        }
    }
...
//        }
        ...
        //zkWatchAPI.createPath( child1Path, "<父-子(1)>节点数据" );
